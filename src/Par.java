...
public class Par {
	...
	Par(FinnStorste getMax, int a[], int coreCount) {
		this.getMax = getMax;
	...
	int[] radixMulti(Timer timer) throws InterruptedException, BrokenBarrierException {
	...
	private class worker implements Runnable {
		...
		worker(int id, int fra, int til) {
			...
			//System.out.println(id + " " + fra + " " + til + " " + a.length);
